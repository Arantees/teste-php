...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="./imagens/user-logo.png">
  ...
  <header>
    <nav class="navbar navbar-expand-lg navCor navbar-light flex-column fixed-top">
      <div class="container">
        <div class="row">
          <div class="col-2">
            <img alt="Logo" src="./imagens/logo-cinza.png" class="img-fluid" />
          </div>
              ...
              <div class="collapse navbar-collapse w-100" id="navbarNavDropdown">
                <ul class="navbar-nav justify-content-around w-100">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-black" href="#" id="navbarDropdownUniversidadeLink"
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-black" href="#" id="navbarDropdownMenuLink" role="button"
